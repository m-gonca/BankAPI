...
public class AccountHolderService {
    ...
    public Transference addTransference(TransferenceDTO transferenceDTO) {
        //First find the receiving account
        Account receiveAccount = accountRepository.findById(transferenceDTO.getReceiveAccountId()).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Account not found"));

        //Second find the account holder of the sending account
